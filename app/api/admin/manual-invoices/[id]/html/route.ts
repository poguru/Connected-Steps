...
export async function GET(req: NextRequest, { params }: Params) {
  ...
  if (!invRes.data) return new NextResponse("Not found", { status: 404 });
...
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .org-logo-text {
    ...
    color: #e8620a; letter-spacing: -0.5px;
  }
  ...
  .party-label {
    ...
    color: #e8620a; margin-bottom: 6px;
  }
  ...
  .amount-words {
    ...
    background: #fff8f3; border: 1px solid #ffd3b5; border-radius: 4px;
    font-size: 10px; color: #4a2700;
  }
  .amount-words strong { font-size: 10px; }
  ...
  .bank-label {
    ...
    text-transform: uppercase; color: #e8620a; margin-bottom: 6px;
  }
  ...
  <div class="header">
    ...
    <div class="invoice-meta">
      ...
      <div class="inv-dates">
        ...
        ${inv.due_date ? `<strong>Due Date:</strong> ${fmtDate(inv.due_date)}<br/>` : ""}
