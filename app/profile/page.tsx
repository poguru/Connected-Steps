      ...
      <div style={{ maxWidth: "520px", margin: "0 auto", padding: "1.5rem 1.25rem 6rem", display: "flex", flexDirection: "column", gap: "1rem" }}>
        ...
        <div className="cs-menu-card">
          {([
            ...
            { label: "My Messages",       href: "/dashboard/comms", icon: (
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/>
              </svg>
            )},
            { label: "Notification Settings", href: "/notifications/preferences", icon: (
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
            ...
            /* AI Food Analyzer — hidden until feature is ready (FOOD_ANALYZER_ENABLED=true) */
