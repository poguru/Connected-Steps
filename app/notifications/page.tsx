...
function typeIcon(type: string): React.ReactNode {
  ...
  switch (type) {
    ...
    case "bug_update":
    case "bug_report":
      return <svg viewBox="0 0 24 24" style={s}><path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10z"/><path d="M12 8v4"/><path d="M12 16h.01"/></svg>;
    default:
