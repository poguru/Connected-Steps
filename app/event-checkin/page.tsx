            ...
            {result.registration && (
              <div style={{ background: "rgba(255,255,255,0.04)", borderRadius: 10, padding: "14px 16px" }}>
                ...
                {result.registration.category && (
                  <div style={{ display: "inline-block", fontSize: 11, fontWeight: 700, color: "#e8620a", background: "rgba(232,98,10,0.12)", border: "1px solid rgba(232,98,10,0.3)", padding: "2px 10px", borderRadius: 999, marginBottom: 8 }}>
                    {result.registration.category}
                  </div>
                )}
