...
export default function MyQuestionsPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--cs-black)", color: "var(--cs-white)" }}>
      ...
      {/* Navbar */}
      <header style={{ position: "sticky", top: 0, zIndex: 50, background: "var(--bg-overlay)", backdropFilter: "blur(20px) saturate(140%)", borderBottom: "1px solid var(--border)", paddingTop: "env(safe-area-inset-top)", display: "flex", alignItems: "center", padding: "0 2rem", minHeight: "calc(var(--nav-h) + env(safe-area-inset-top))", gap: "0.75rem" }}>
