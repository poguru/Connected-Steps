...
const TYPE_PLACEHOLDERS: Record<string, string> = {
  "Rest":                               "Recovery day",
  "Endurance training":                 "e.g. 12 km at comfortable aerobic pace",
  "Speed training":                     "e.g. 8 × 200m at 5K race pace with 90s rest",
  "Tempo training":                     "e.g. 6 km at threshold pace (comfortably hard)",
  "Hill Training":                      "e.g. 6 × 200m hill repeats, walk back recovery",
  "Interval training":                  "e.g. 6 × 400m at 3K pace with 90s rest",
  "Strength training":                  "e.g. Leg press, squats, lunges — 3 sets each, 45 min",
  "Core stability and mobility training": "e.g. Plank, dead bugs, hip circles — 30 min",
  "Recovery training":                  "e.g. 3 km very easy jog, heart rate below 130",
  "Race - specific training":           "e.g. 5K race simulation at goal pace",
  "Flexibility and mobility training":  "e.g. Full body stretch and foam roll — 30 min",
};
