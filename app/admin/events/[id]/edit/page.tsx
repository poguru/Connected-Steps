                      ...
                      {isEditing && (
                        <div style={{ padding: "16px", borderTop: "1px solid rgba(255,255,255,0.06)", background: "rgba(232,98,10,0.03)" }}>
                          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12, marginBottom: 12 }}>
                            ...
                            <Field label="Early Bird (₹)"><input type="number" style={S.input} value={raceForm.early_bird_price ?? ""} onChange={e => setRaceForm(f => ({ ...f, early_bird_price: e.target.value ? Number(e.target.value) : null }))} placeholder="Same as price" min="1" /></Field>
            ...
            {raceEditId === null && (
              <div style={{ borderTop: races.length > 0 ? "1px solid rgba(255,255,255,0.07)" : undefined, paddingTop: races.length > 0 ? 20 : 0 }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12, marginBottom: 14 }}>
                  ...
                  <Field label="Early Bird (₹)"><input type="number" style={S.input} value={raceForm.early_bird_price ?? ""} onChange={e => setRaceForm(f => ({ ...f, early_bird_price: e.target.value ? Number(e.target.value) : null }))} placeholder="Blank = none" min="1" /></Field>
                  <Field label="Max Slots"><input type="number" style={S.input} value={raceForm.max_slots ?? ""} onChange={e => setRaceForm(f => ({ ...f, max_slots: e.target.value ? Number(e.target.value) : null }))} placeholder="Unlimited" /></Field>
