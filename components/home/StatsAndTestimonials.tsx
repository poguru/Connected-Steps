...
const FALLBACK = [
  { id: -1, user_name: "Priya M.",   achievement: "Hyderabad — Half Marathon finisher", quote: "I went from barely running 2km to completing my first half marathon in 14 weeks. My coach adjusted the plan when life got busy and I never felt alone." },
  { id: -2, user_name: "James O.",   achievement: "London — Full Marathon, 3:41",       quote: "The analytics alone are worth it. Seeing my pace improve week-on-week kept me coming back. The community pushes you on days you don't want to lace up." },
  { id: -3, user_name: "Sunita R.",  achievement: "Bengaluru — 5K PB: 23:14",          quote: "I have been a runner for years but I was plateauing. My Connected Steps coach identified the issue in the first week. Six weeks later, new PB." },
];

interface Story { id: number; user_name: string; achievement: string; quote: string; }
  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", gap: "3px" }}>
        {[...Array(5)].map((_, i) => (
          <svg key={i} width="13" height="13" viewBox="0 0 14 14" fill="var(--cs-orange)">
      ...
      <section id="community" className="section" style={{ background: "var(--cs-dark)" }}>
        <div style={{ textAlign: "center", marginBottom: "3rem" }}>
          ...
          <p style={{ fontSize: "0.875rem", color: "var(--cs-muted)", marginTop: "0.75rem" }}>
            Stories shared by our community. <a href="/dashboard" style={{ color: "var(--cs-orange)", textDecoration: "none" }}>Share yours →</a>
          </p>
        </div>
